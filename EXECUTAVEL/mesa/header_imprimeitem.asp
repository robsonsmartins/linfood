<head>
<title>Sistema LinFOOD - Impressão do Pedido</title>
<style type="text/css"><!--
  ...
  <table border="0" cellspacing="0" width="100%" cellpadding="0">
    <tr>
      ...
      <td width="47%" bgcolor="#008000">
        <p align="center"><b><font face="Arial" size="3" color="#C0C0C0">Pedido</font></b></p>
    </td>
    </tr>
    <tr>
        ...
        <div align="center">
          <table border="0" cellpadding="2" cellspacing="0" width="100%" bgcolor="#DADADA">
            <tr>
              ...
              <td width="0%"><a href="javascript:print();"><img border="0" src="../imagens/print.gif" alt="Imprimir Pedido" width="25" height="25"></a></td>
              <td width="96%">
