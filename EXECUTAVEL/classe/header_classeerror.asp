...
<head>
<title>Sistema LinFOOD - Erro ao Salvar Categoria de Produto</title>
<style type="text/css"><!--
  ...
  <table border="0" cellspacing="0" width="100%" cellpadding="0">
    <tr>
      ...
      <td width="47%" bgcolor="#008000">
        <p align="center"><b><font face="Arial" size="3" color="#C0C0C0">Erro ao
        Salvar Categoria de Produto</font></b></p>
    </td>
    </tr>
    <tr>
